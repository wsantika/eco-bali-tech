...
const skills = [
  {
    ...
    description:
      "Membangun platform interaktif menggunakan Next.js, React, dan TypeScript.",
    color: "#16A34A",
  },
  {
    icon: Palette,
    title: "UI/UX Design",
    description:
      "Merancang antarmuka yang modern, intuitif, dan menarik secara visual.",
    color: "#8B5CF6",
  },
  {
    icon: BarChart3,
    ...
    description:
      "Menampilkan data lingkungan dalam bentuk grafik dan dashboard yang informatif.",
    color: "#0EA5E9",
  },
  {
    icon: Database,
    ...
    description:
      "Mengelola data lokasi, pengguna, dan metrik lingkungan secara terstruktur.",
    color: "#F59E0B",
  },
  {
    icon: Cpu,
    ...
    description:
      "Potensi masa depan: prediksi volume sampah dan optimasi rute pengangkutan.",
    color: "#EF4444",
  },
  {
    icon: Rocket,
    ...
    description:
      "Potensi masa depan: sensor pintar untuk monitoring tempat sampah real-time.",
    color: "#14B8A6",
  },
];
      ...
      <div className="relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-eco-gray-light max-w-2xl mx-auto animate-on-scroll">
            Proyek EcoBali Tech menunjukkan bagaimana mahasiswa Teknologi
            Informasi bisa menciptakan solusi nyata untuk permasalahan
            lingkungan melalui berbagai skill IT.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
          {skills.map((skill) => (
            ...
            >
              ...
              <p className="text-sm text-eco-gray-light leading-relaxed">
                {skill.description}
              </p>
            </div>
          ))}
        ...
        <div className="glass-dark p-8 sm:p-10 rounded-2xl text-center animate-on-scroll bg-gradient-to-r from-eco-green/10 to-eco-blue/10 border-eco-green/20">
          ...
          <p className="text-eco-gray-light max-w-2xl mx-auto mb-6 leading-relaxed">
            Di Kampus Universitas Pendidikan Nasional Fakultas Teknik dan
            Informatika Prodi Teknologi Informasi, kamu akan belajar membangun
            solusi digital yang berdampak mulai dari web development, data
            science, hingga artificial intelligence. Jadilah bagian dari
            generasi yang menggunakan teknologi untuk kebaikan!
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://undiknas.ac.id/" className="btn-primary text-lg">
